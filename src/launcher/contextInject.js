...
function syncSection(palName) {
    return [
        ...
        "   Push runs `pal_validate` automatically and refuses on errors YOUR change introduced — fix",
        "   them rather than reaching for `skipValidation`. (Pre-existing errors in a file you edit",
        ...
        "5. To SEE the rendered output yourself, use **`pal_preview`**. For a WEB pal it returns the",
        ...
        "6. For a WEB pal page (public, crawled), also run **`pal_seo_audit`** after pushing — it",
