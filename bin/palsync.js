...
const SUBCOMMANDS = ["push", "pull", "status", "test", "validate", "sync-datasets"];
...
if (argv[0] === "help" || argv.includes("--help") || argv.includes("-h")) {
    process.stdout.write(
        ...
        "  palsync push|pull|status|test|validate|sync-datasets   headless ops for a workspace (no MCP/agent needed)\n" +
